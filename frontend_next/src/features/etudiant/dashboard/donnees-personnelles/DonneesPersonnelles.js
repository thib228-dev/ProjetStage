      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">EKOUÉ</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <FaUser className="text-black" />
          <div>
            ...
            <div className="font-bold text-lg text-black">Afi Sandrine</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">20-03-2004</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">afi.sandrine@epl.tg</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">+228 90 00 00 00</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">Lomé, Togo</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">Féminin</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">Licence professionnelle</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-bold text-lg text-black">Génie logiciel</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <FaGraduationCap className="text-black" />
          <div>
            ...
            <div className="font-bold text-lg text-black">Licence 3</div>
          </div>
        </div>
      </div>
    </div>
